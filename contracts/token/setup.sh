...
function deploy_contract {
  CONTRACT_ADDRESS=$(cargo +nightly-2023-01-17-aarch64-apple-darwin contract instantiate --url "$NODE_URL" --suri "$AUTHORITY_SEED" --constructor new --args \"${TOKEN_NAME}\" \"${TOKEN_SYMBOL}\" ${DECIMALS} ${TOTAL_SUPPLY} --skip-confirm)
